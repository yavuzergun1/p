...
function getThemedLogo(metadata) {
    ...
    if (!logo) {
        if ('getLogo' in metadata) {
            return (_b = (_a = metadata.getLogo()) === null || _a === void 0 ? void 0 : _a[theme]) !== null && _b !== void 0 ? _b : (_c = metadata.getLogo()) === null || _c === void 0 ? void 0 : _c[oppositeColorScheme];
        }
    ...
    return (_d = logo[theme]) !== null && _d !== void 0 ? _d : logo[oppositeColorScheme];
}
