...
class ErrorMessage extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$t, create_fragment$C, safe_not_equal, { title: 0, details: 1 }, add_css$k);
	}
}
...
class Wharf extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$r, create_fragment$w, safe_not_equal, { size: 0 });
	}
}
...
class Icon extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$q, create_fragment$q, safe_not_equal, { name: 0, size: 1 });
	}
}
...
class Button extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$p, create_fragment$p, safe_not_equal, { data: 5 }, add_css$j);
	}
}
...
function add_css$h(target) {
	append_styles(target, "svelte-wqlv91", ".asset.svelte-wqlv91.svelte-wqlv91{padding:10px 0;text-align:center}.asset.svelte-wqlv91>.svelte-wqlv91{margin:0}.value.svelte-wqlv91.svelte-wqlv91{font-size:var(--fs-2);font-weight:600;color:var(--body-text-color)}.label.svelte-wqlv91.svelte-wqlv91{font-size:var(--fs-0);font-weight:400;color:var(--body-text-color-variant)}");
}
...
function create_if_block$a(ctx) {
	...
	return {
		c() {
			...
			p1 = element("p");
			t2 = text(t2_value);
			attr(p0, "class", "value svelte-wqlv91");
			attr(p1, "class", "label svelte-wqlv91");
			attr(div, "class", "asset svelte-wqlv91");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			append(div, p0);
...
class Asset extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$m, create_fragment$m, safe_not_equal, { data: 0 }, add_css$h);
	}
}
...
class Close extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$l, create_fragment$l, safe_not_equal, {}, add_css$g);
	}
}
...
class Link extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$k, create_fragment$k, safe_not_equal, { data: 4 }, add_css$f);
	}
}
...
class Textarea extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$h, create_fragment$h, safe_not_equal, { data: 0 }, add_css$d);
	}
}
...
function add_css$8(target) {
	append_styles(target, "svelte-p7bfgq", "li.svelte-p7bfgq.svelte-p7bfgq{display:flex}li.svelte-p7bfgq:not(:last-child) button.svelte-p7bfgq{border-bottom:1px solid var(--list-divider-color)}li.svelte-p7bfgq button.svelte-p7bfgq{flex:1;display:flex;align-items:center;gap:var(--space-s);cursor:pointer;border:none;background:none;color:var(--body-text-color);font-size:var(--fs-1);font-weight:500;padding-block:var(--space-s)}.leading.svelte-p7bfgq.svelte-p7bfgq{flex-basis:var(--space-xl);display:grid;place-content:center;height:32px;min-height:32px;width:32px;min-width:32px}.leading.svelte-p7bfgq .icon.svelte-p7bfgq,.leading.svelte-p7bfgq .logo.svelte-p7bfgq{max-width:32px;max-height:32px}.icon.trailing.svelte-p7bfgq.svelte-p7bfgq{opacity:0.2}li.svelte-p7bfgq button.svelte-p7bfgq:hover{background:var(--list-item-background-color-hover)}li.svelte-p7bfgq button:hover .icon.trailing.svelte-p7bfgq{opacity:1}span.svelte-p7bfgq.svelte-p7bfgq{flex:1;text-align:start;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}");
}
...
function create_if_block_2$3(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "icon svelte-p7bfgq");
		},
		m(target, anchor) {
			insert(target, div, anchor);
...
function create_if_block_1$4(ctx) {
	...
	return {
		c() {
			img = element("img");
			attr(img, "class", "logo svelte-p7bfgq");
...
function create_if_block$6(ctx) {
	...
	return {
		c() {
			div = element("div");
			create_component(icon.$$.fragment);
			attr(div, "class", "icon trailing svelte-p7bfgq");
		},
		m(target, anchor) {
			insert(target, div, anchor);
			mount_component(icon, div, null);
...
function create_fragment$c(ctx) {
	...
	return {
		c() {
			...
			attr(div, "class", "leading svelte-p7bfgq");
			attr(span, "class", "svelte-p7bfgq");
			attr(button, "class", "svelte-p7bfgq");
			attr(li, "class", "svelte-p7bfgq");
		},
		m(target, anchor) {
...
function create_each_block$2(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*chains*/ 1) listitem_changes.logo = /*chain*/ ctx[4].getLogo();
...
class Blockchain extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$b, create_fragment$b, safe_not_equal, { chains: 0, title: 1 }, add_css$7);
	}
}
...
class WarningMessage extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$9, create_fragment$9, safe_not_equal, { title: 0, details: 1 }, add_css$5);
	}
}
...
class Permission extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$8, create_fragment$8, safe_not_equal, { client: 14, walletPlugin: 0, title: 1 }, add_css$4);
	}
}
...
function create_if_block$3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*$$scope, wallets, colorScheme*/ 517) {
				list_changes.$$scope = { dirty, ctx };
			}
...
// (35:12) {#each wallets as wallet, index}
function create_each_block(ctx) {
	let listitem;
	let current;

	function func() {
		return /*func*/ ctx[5](/*index*/ ctx[8]);
	}

	listitem = new ListItem({
			props: {
				label: /*wallet*/ ctx[6].metadata.name,
				onClick: func,
				leadingIcon: "wallet",
				logo: /*hasValidLogo*/ ctx[4](/*wallet*/ ctx[6])
				? /*wallet*/ ctx[6].metadata.logo[/*colorScheme*/ ctx[2]]
				: undefined
			}
		});
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const listitem_changes = {};
			if (dirty & /*wallets*/ 1) listitem_changes.label = /*wallet*/ ctx[6].metadata.name;

			if (dirty & /*wallets, colorScheme*/ 5) listitem_changes.logo = /*hasValidLogo*/ ctx[4](/*wallet*/ ctx[6])
			? /*wallet*/ ctx[6].metadata.logo[/*colorScheme*/ ctx[2]]
			: undefined;
...
function create_default_slot$2(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*wallets, dispatch, hasValidLogo, colorScheme, undefined*/ 29) {
...
function instance$7($$self, $$props, $$invalidate) {
	...
	const hasValidLogo = ({ metadata: { logo, name } }) => {
	...
	if (window.matchMedia) {
		...
		window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', event => {
			$$invalidate(2, colorScheme = event.matches ? 'dark' : 'light');
		});
	}
	...
	return [wallets, title, colorScheme, dispatch, hasValidLogo, func];
}

class Wallet extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$7, create_fragment$7, safe_not_equal, { wallets: 0, title: 1 }, add_css$3);
	}
}
...
class Transition extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$6, create_fragment$6, safe_not_equal, { direction: 0 });
	}
}
...
class HeaderButton extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$4, create_fragment$4, safe_not_equal, { onClick: 0, icon: 1 }, add_css$2);
	}
}
...
function add_css$1(target) {
	append_styles(target, "svelte-3a4t7d", ".modal-header.svelte-3a4t7d.svelte-3a4t7d{box-sizing:border-box;min-height:var(--header-height);color:var(--header-text-color);background:var(--header-background-color);display:grid;grid-template-columns:1fr auto 1fr;gap:var(--space-s);padding:var(--space-m)}.modal-header.svelte-3a4t7d .slot.svelte-3a4t7d{display:flex;align-items:center}.modal-header.svelte-3a4t7d .center.svelte-3a4t7d{flex-direction:column;justify-content:space-around;text-align:center}.modal-header.svelte-3a4t7d .right.svelte-3a4t7d{justify-content:flex-end}.modal-header.svelte-3a4t7d .svelte-3a4t7d:is(h2, p){margin:0;line-height:1.1em}.modal-header.svelte-3a4t7d h2.svelte-3a4t7d{font-size:var(--fs-3);font-weight:700}.modal-header.svelte-3a4t7d p.svelte-3a4t7d{font-size:var(--fs-0)}");
}
...
function fallback_block(ctx) {
	...
	headerbutton = new HeaderButton({
			props: { icon: "close", onClick: /*func*/ ctx[6] }
		});
...
function create_fragment$3(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "slot left svelte-3a4t7d");
			attr(div1, "class", "slot center svelte-3a4t7d");
			attr(div2, "class", "slot right svelte-3a4t7d");
			attr(div3, "class", "modal-header svelte-3a4t7d");
		},
		m(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
	...
	return [title, subtitle, $backAction, dispatch, $$scope, slots, func];
}
...
function create_fragment$2(ctx) {
	...
	header = new Header({
			props: {
				title: /*$props*/ ctx[1].title,
				subtitle: /*$props*/ ctx[1].subtitle
			}
		});

	header.$on("cancel", /*cancelRequest*/ ctx[2]);
	...
	return {
		c() {
			...
			div = element("div");
			if (default_slot) default_slot.c();
			attr(div, "class", "modal-content svelte-yerl3w");
			attr(dialog_1, "class", "svelte-yerl3w");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(dialog_1, "click", /*backgroundClose*/ ctx[3], { passive: false, capture: true }),
					listen(dialog_1, "keyup", prevent_default(/*escapeClose*/ ctx[4]), { passive: false, capture: true })
				];
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$props*/ 2) header_changes.title = /*$props*/ ctx[1].title;
			if (dirty & /*$props*/ 2) header_changes.subtitle = /*$props*/ ctx[1].subtitle;
...
const defaultWebUIRendererOptions = {
    id: 'wharfkit-web-ui',
};
const getNavigatorLanguage = () => (navigator.languages && navigator.languages.length
    ? navigator.languages[0]
    : navigator.language || 'en').split('-')[0];
class WebUIRenderer extends session.AbstractUserInterface {
    constructor(options = defaultWebUIRendererOptions) {
        super();
    ...
    onLogin() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            props.update((current) => (Object.assign(Object.assign({}, current), { title: this.i18n.t.get('login.title', { default: 'Login' }), subtitle: this.i18n.t.get('login.subtitle', { default: 'Please login to continue.' }) })));
            // Push the new path to the router
            router.push('login');
        });
    }
    ...
    onTransact() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            props.update((c) => (Object.assign(Object.assign({}, c), { title: this.i18n.t.get('transact.title', { default: 'Transact' }), subtitle: this.i18n.t.get('transact.subtitle', { default: ' ' }) })));
            // Push the new path to the router
    ...
    onSign() {
        return __awaiter(this, void 0, void 0, function* () {
            this.log('onSign');
            // Set the title/subtitle to match the transact state
            props.update((c) => (Object.assign(Object.assign({}, c), { subtitle: this.i18n.t.get('transact.signing', { default: 'Signing transaction' }) })));
        });
    }
    onSignComplete() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Set the title/subtitle to match the transact state
            props.update((c) => (Object.assign(Object.assign({}, c), { subtitle: this.i18n.t.get('transact.signed', { default: 'Transaction signed' }) })));
        });
    }
    onBroadcast() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Set the title/subtitle to match the transact state
            props.update((c) => (Object.assign(Object.assign({}, c), { subtitle: this.i18n.t.get('transact.broadcasting', {
    ...
    onBroadcastComplete() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Set the title/subtitle to match the transact state
            props.update((c) => (Object.assign(Object.assign({}, c), { subtitle: this.i18n.t.get('transact.broadcasted', {
...
WebUIRenderer.version = '0.3.7'; // replaced by build script

exports.WebUIRenderer = WebUIRenderer;
exports["default"] = WebUIRenderer;
exports.defaultWebUIRendererOptions = defaultWebUIRendererOptions;
//# sourceMappingURL=web-ui-renderer.js.map
